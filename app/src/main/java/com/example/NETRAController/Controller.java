...
public class Controller extends AppCompatActivity {
    private Button  A,B, C, D, E, Back,Grip,Ungrip,Reconnect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(currentMode== Configuration.UI_MODE_NIGHT_YES){
            ...
            Reconnect.setTextColor(Color.parseColor("#E6E3E3"));
            joystickLib.setBorderColor(Color.BLACK);
            joystickLib.setButtonColor(Color.WHITE);
            Cammand.setTextColor(Color.WHITE);
        }
        else{
            ...
            Cammand.setTextColor(Color.BLACK);
        }
...
//        });
        ...
        setupButtonTouchListeners(B,"C");
        setupButtonTouchListeners(C,"P");
        setupButtonTouchListeners(D,"Q");
        ...
        Reconnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (BluetoothSingleton.getInstance().isConnected()) {
                    ...
                    if ( BluetoothSingleton.getInstance().prevDevice!= null) {
                        flag = 1;
                        BluetoothDevice device = BluetoothSingleton.getInstance().prevDevice;
